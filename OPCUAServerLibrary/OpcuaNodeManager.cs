    ...
    public override void CreateAddressSpace(IDictionary<NodeId, IList<IReference>> externalReferences)
    {
        lock (Lock)
        {
            ...
            try
            {
                ...
                variables.Add(CreateVariable(staticFolder, scalarStatic + "Time", "Time", DataTypeIds.DateTime, ValueRanks.Scalar));
                ...
                byte[] largeInteger = BitConverter.GetBytes(long.Parse("1234567890123546789012345678901234567890123456789012345"));
                DecimalDataType decimalValue = new DecimalDataType();
                decimalValue.Scale = 100;
                decimalValue.Value = largeInteger;
                ...
                variables.Add(CreateVariable(arraysFolder, staticArrays + "Time", "Time", DataTypeIds.DateTime, ValueRanks.OneDimension));
                ...
                variables.Add(CreateVariable(arrays2DFolder, staticArrays2D + "Time", "Time", DataTypeIds.DateTime, ValueRanks.TwoDimensions));
                ...
                variables.Add(CreateVariable(arrayDymnamicFolder, staticArraysDynamic + "Time", "Time", DataTypeIds.DateTime, ValueRanks.OneOrMoreDimensions));
                ...
                variables.AddRange(CreateVariables(massFolder, staticMass + "Time", "Time", DataTypeIds.DateTime, ValueRanks.Scalar, 100));
                ...
                CreateDynamicVariable(simulationFolder, scalarSimulation + "Time", "Time", DataTypeIds.DateTime, ValueRanks.Scalar);
                ...
                CreateDynamicVariable(arraysSimulationFolder, simulationArrays + "Time", "Time", DataTypeIds.DateTime, ValueRanks.OneDimension);
                ...
                CreateDynamicVariables(massSimulationFolder, massSimulation + "Time", "Time", DataTypeIds.DateTime, ValueRanks.Scalar, 100);
                ...
                CreateAnalogItemVariable(analogArrayFolder, daAnalogArray + "Time", "Time", DataTypeIds.DateTime, ValueRanks.OneDimension, new string[] { DateTime.MinValue.ToString(), DateTime.MaxValue.ToString(), DateTime.MinValue.ToString(), DateTime.MaxValue.ToString(), DateTime.MinValue.ToString(), DateTime.MaxValue.ToString(), DateTime.MinValue.ToString(), DateTime.MaxValue.ToString(), DateTime.MinValue.ToString(), DateTime.MaxValue.ToString() }, null);
